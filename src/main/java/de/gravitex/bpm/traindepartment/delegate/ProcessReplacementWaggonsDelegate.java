...
public class ProcessReplacementWaggonsDelegate extends TrainDepartmentJavaDelegate {
	...
	public void execute(DelegateExecution execution) throws Exception {
		...
		String[] deliveredWaggons = (String[]) execution.getProcessEngine().getRuntimeService().getVariable(execution.getId(),
				DepartTrainProcessConstants.VAR_DELIVERED_REPLACMENT_WAGGONS);
